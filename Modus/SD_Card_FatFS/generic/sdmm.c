...
#define PIN_MCU_MOSI			P5_0
#define PIN_MCU_MISO			P5_1
...
#define CS_L()		cyhal_gpio_write(PIN_MCU_CS, false)	/* Set MMC CS "low" */
...
static
int cselect (void)	/* 1:OK, 0:Timeout */
{
	BYTE d;
